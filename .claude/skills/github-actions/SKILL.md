---
name: github-actions
description: GitHub Actions CI/CD best practices — workflow structure, secret management, caching, matrix strategies, and deployment gating. Load when editing .github/workflows/.
---
