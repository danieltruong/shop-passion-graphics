...
description: Core Web Vitals (LCP, INP, CLS) standards with anti-patterns and framework-specific fixes. Load when investigating bundle size, render cost, or perceived load performance.
---
